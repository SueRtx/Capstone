...
import './about.scss'
import drImg from "../../components/images/ab-drAhn.jpg";
import philImg from "../../components/images/ab-Philosophy.png";
    ...
    <>
      <div className="section-about-wrapper section__padding">
        ...
        <article className="section-about-description">
          ...
          <Fade bottom>  
            <img src={drImg } className="drAhn-Img" alt="temp" width='20%' />
          ...
          <br />
          <Fade bottom >
            <img src={philImg } className="phil-Img" alt="temp" width='20%'  />
